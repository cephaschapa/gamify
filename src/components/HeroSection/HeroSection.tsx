...
import { heroSectionClassNames } from "./HeroSectionClassNames";
        ...
        <section className={hero}>
            <div className={grid}>
                <div className={content}>
                    ...
                    <p className={paragraph}>Discover, Learn and conquer with Our Extensive Collection of Games.</p>
                    {
                        showLink && (
